    ...
    <div class="well">
        ...
        <form:form method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <form:input readonly="true" path="title" class="form-control" type="text"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="description">Description</label>
                <div class="col-sm-7">
                    <form:input readonly="true" path="description" class="form-control" type="text"/>
                </div>
            </div>
            <div class="form-group" id="startTime">
                <label class="col-sm-4 control-label" for="startTimeString">Start time</label>
                <div class="col-sm-7">
                    <form:input readonly="true" path="startTimeString" class="form-control" type="text"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="endTimeString">End time</label>
                <div class="col-sm-7">
                    <form:input readonly="true" path="endTimeString" class="form-control" type="text"/>
                </div>
            </div>
        </form:form>
    </div>
